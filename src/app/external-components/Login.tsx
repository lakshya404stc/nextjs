        ...
        <div className="container h-full px-6 py-24">
            ...
            <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                ...
                <div className="relative mb-6" data-te-input-wrapper-init>
                    ...
                    type="password"
                    {...register("password")}
                    className="peer block min-h-[auto] w-full rounded border-2 bg-transparent px-3 py-[0.32rem] leading-[2.15]  transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
