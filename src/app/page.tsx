...
export default function Home() {
  return (
   <>
   <MaxWidthWrapper className="mb-12 mt-10 sm:mt-25 flex flex-wrap flex-col items-center text-center justify-center">
      <div className="mx-auto mt-[70px] mb-4 flex max-w-fit items center justify-center space-x-2 overflow-hidden rounded-full border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
        ...
        <div className='mb-12 px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl sm:text-center'>
            <h2 className='mt-2 font-bold text-4xl text-gray-900 sm:text-5xl'>
              Creating New Content never been easier
            </h2>
            <p className='mt-4 text-lg text-gray-600'>
              With just few clicks save your time
            </p>
          </div>
        </div>
        ...
        <ol className='my-8 space-y-4 ml-5 pt-8 md:flex md:space-x-12 md:space-y-0'>
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='text-xl font-semibold'>
                Upload your Channel Link
              </span>
              <span className='mt-2 text-zinc-700'>
                We&apos;ll process your Videos and Generate similar Content Ideas for you
              </span>
            </div>
          </li>
          <li className='md:flex-1'>
